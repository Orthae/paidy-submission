mod item_router_tests {
    ...
    mod item_router_tests {
        ...
        mod create_items_endpoint {
            ...
            use mockall::predicate::eq;
            use uuid::Uuid;
            use paidy_submission::application::item_service::{CreateItemModel, CreateItemsCommand, ItemModel, MockItemService};
            use crate::item_router_tests::ItemRouterTestContext;
            use super::*;
            ...
            async fn should_create_items() {
                let command = CreateItemsCommand {
                    items: vec![
                        CreateItemModel {name: "Pierogi".to_string()}, 
                        CreateItemModel {name: "Schabowy".to_string()}, 
                    ]
                };
        ...
        mod delete_item_endpoint {
            ...
            async fn should_delete_item() {
                ...
                let response = context.client.delete(url)
                    .send()
                    .await
                    .expect("Failed to get response");
            ...
            async fn should_reject_request_bad_table_id() {
                ...
                let url = format!("http://{}/tables/{}/items/{}", context.address, "bad_id", item_id);
                let response = context.client.delete(url)
                    .send()
                    .await
                    .expect("Failed to get response");
